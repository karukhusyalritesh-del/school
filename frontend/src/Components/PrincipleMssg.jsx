    ...
    >
      <div className="flex justify-between items-center w-full max-lg:flex-col max-lg:gap-8">
        ...
        <div className="flex-1 max-lg:order-2">
          ...
          >
            <FaGraduationCap className="mr-2.5 max-lg:text-2xl" /> Words From Principal
          </h2>
          <p
          ...
          >
            ...
            year. My name is Rundi Prasad Chaudhary, and I am honored to be your principal. First, I want to
